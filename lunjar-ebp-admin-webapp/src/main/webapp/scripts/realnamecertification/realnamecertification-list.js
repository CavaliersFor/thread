    ...
    $(".act_pass").click(function(){
        ...
        Core.PopUtil.confirm(msg, function () {
            ...
            AncunApiClient.postForm('audit', {
                data: {"partnerId":partnerId,"status":2},
...
function editWin(partnerId,status){
    ...
    function loadData(){
        ...
        var values={"partnerId":partnerId,"status":status};
        Core.FormUtils.setFormValues(_editForm,values);//填充表单

        _loading.hide();
        _editForm.show();

        //AncunApiClient.getJson('load',{
        //    data:{id:id},
        //    success:function(response){
        //        //console.log(response.data);
        //        Core.FormUtils.setFormValues(_editForm,response.data);//填充表单
        //        _loading.hide();
        //        _editForm.show();
        //    }
        //});
